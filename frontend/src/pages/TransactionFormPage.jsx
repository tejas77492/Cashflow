...
export default function TransactionFormPage() {
  ...
  const preview = useMemo(() => {
    ...
    const profit = customerCharge - discount - portalCost;
    return { customerCharge, portalCost, profit, globalPct, portalPct };
          ...
          <div className="panel" style={{ marginTop: 16 }}>
            ...
            <div className="metric-list">
              ...
              <div className="metric-row">
                ...
                <span className="metric-value">Charge − Discount − Portal Cost</span>
              </div>
            </div>
          </div>
        </div>
