...
export default function AdminDashboard() {
  ...
  const txCols = [
    { key: "date", label: "Date" },
    { key: "branch_name", label: "Branch" },
    { key: "type", label: "Type", render: (r) => <span className={`badge ${r.type === "cc" ? "badge-blue" : "badge-amber"}`}>{formatTransactionType(r.type)}</span> },
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14, flexWrap: "wrap" }}>
          ...
          <div style={{ marginLeft: "auto" }}>
            <button
              ...
              onClick={() => exportMonthlyReportXls({ month, transactions, expenses: [], summary: overviewSummary, branchName: "All Branches" })}
            >
              ↓ Export Excel Report
            </button>
          </div>
